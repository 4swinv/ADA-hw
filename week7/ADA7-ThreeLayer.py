# Implementation of a Three-layer neural network for MNIST classification
...
for epoch in range(1, 1+epochs):
    ...
    print('', end='\n')
    # Notice how we are doing a full forward pass again at the end of each epoch to compute the train in loss and accuracy,
